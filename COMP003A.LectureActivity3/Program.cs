...
namespace COMP003A.LectureActivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //this code block executes if the above conditions is true 
                // the rest of the conditions will no longer execute
                Console.WriteLine("\tinput number is divisible by 3.");
            }
            ...
            else if (inputNumber % 7 == 0)
            {
                //this code block executes if the above conditions is true 
                // the rest of the conditions will no longer execute
                Console.WriteLine("\tinput number is divisible by 7.");
            }
            else
            {
            ...
            int randomNumber = new Random().Next(10); //generates a random number below
